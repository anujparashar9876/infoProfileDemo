...
class OTPForgetScreen extends StatefulWidget {
  final String email;
  const OTPForgetScreen({super.key,required this.email});
...
class _OTPForgetScreenState extends State<OTPForgetScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text(AppString.otptitle),),
      body: Column(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Image.asset(AppImages.otp,scale: 0.4,),
          const Text(AppString.verify,style: StringTextStyle.logintitle,),
          ...
          OtpTextField(
            ...
            onSubmit: (String verificationCode) {
              ...
              authViewModel.forgetpasswordOTP(data, context);              
            }, // end onSubmit
          ),
